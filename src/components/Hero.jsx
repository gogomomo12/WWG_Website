...
const Hero = ({ hero: { title, subtitle, btn1, btn2, text, text2, img } }) => {
  return (
   <>
      <div className='flex flex-col bg-gradient-to-b from-emerald-200 to-white h-auto w-auto'>
        <div className='wwg-container grid items-start justify-items-center'>
          <div className='grid items-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12'>
            ...
            <h1 className='text-6xl font-bold lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl text-teal-500 filter drop-shadow-lg'>{subtitle}</h1>

            <p className='text-base my-7 mt-10 w-full w-2/3 sm:w-100 mx-auto text-center sm:text-sm'>{text}</p>


            <div className='flex items-center justify-center gap-11 sm:gap-3 sm:flex-col sm:w-full'>
              <Link href={'/store'}><button type='button' className='button-emrald'>{btn1}</button></Link>

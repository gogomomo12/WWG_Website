...
// GAWA NG DATABASE PARA SA ADDONS

// Product - Feature
import Product from "../components/Product"; // gagawa ako para sa addons nito.
  ...
  return (
    <Layout>
      ...
      {productsInfos.length && productsInfos.map(productInfo => {
        ...
        <div className="flex mb-5 items-center border-r-2 border-gray-200 pr-4" key={productInfo._id}>
